...
def api_root(request):
    ...
    return JsonResponse({
        ...
        "endpoints": {
            ...
            "clients": {
                "clientdashboard": f"{base}/api/clientdashboard/",
                "client_public_dashboard": f"{base}/api/client_public_dashboard/",
                "clientall": f"{base}/api/clientall/<client_id>/",
                "add_client": f"{base}/api/add_client/",
                "update_client": f"{base}/api/update_client/<client_id>/",
                "delete_client": f"{base}/api/delete_client/<client_id>/",
            },
            "blog": {
                "blogdashboard": f"{base}/api/blogdashboard/",
                "blogs_public_dashboard": f"{base}/api/blogs_public_dashboard/",
                "blogall": f"{base}/api/blogall/<blog_id>/",
                "blog_image": f"{base}/api/blog_image/<blog_id>/",
